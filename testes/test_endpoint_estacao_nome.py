...
def testGet():
    ...
    response = requests.get(url_base+'/estacao/teste', headers=headers)
    print(response)
    print(response.text)
    return 0
...
def testPost():
    ...
    response = requests.post(url_base+'/estacao/teste', headers=headers)
    print(response)
    print(response.text)
    return 0
...
def testDelete():
    ...
    response = requests.delete(url_base+'/estacao/teste', headers=headers)
    print(response)
    print(response.text)
    return 0
